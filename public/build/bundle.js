...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (default_slot) default_slot.c();
    			attr_dev(button, "class", button_class_value = "" + (null_to_empty(/*$$props*/ ctx[4].class) + " svelte-1hhx4uf"));
    			toggle_class(button, "selected", /*$selectedTab*/ ctx[0] === /*tab*/ ctx[1]);
    			add_location(button, file$3, 31, 0, 601);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*$$props*/ 16 && button_class_value !== (button_class_value = "" + (null_to_empty(/*$$props*/ ctx[4].class) + " svelte-1hhx4uf"))) {
    ...
    // (12:8) {#if request.properties.businessName}
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 12, 12, 646);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(12:8) {#if request.properties.businessName}",
    		ctx
    	});
    ...
    class RequestCard extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { request: 0 });
    ...
    const file$5 = "src/Requests.svelte";
    ...
    function create_default_slot_5(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(15:12) <Tab class=\\\"cleanup\\\">",
    		ctx
    	});
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			div = element("div");
    			add_location(p, file$5, 19, 12, 615);
    			attr_dev(div, "class", "cleanup-requests");
    			add_location(div, file$5, 20, 12, 731);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_1(ctx) {
    	...
    	let div;
    	let current;
    	let each_value = /*artRequests*/ ctx[0];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$5, 26, 12, 850);
    			attr_dev(div, "class", "art-requests");
    			add_location(div, file$5, 27, 12, 934);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			insert_dev(target, t1, anchor);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*artRequests*/ 1) {
    				each_value = /*artRequests*/ ctx[0];
    				validate_each_argument(each_value);
    				let i;
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$5, 11, 4, 394);
    			add_location(section, file$5, 10, 0, 380);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ("artRequests" in $$props) $$invalidate(0, artRequests = $$props.artRequests);
    	};
    ...
    function create_default_slot_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			i1 = element("i");
    			t3 = text("Art Install");
    			attr_dev(i0, "class", "icon-earthquake-fill svelte-5feb6q");
    			add_location(i0, file$7, 16, 91, 409);
    			attr_dev(a0, "class", "request-cleanup-cta svelte-5feb6q");
    			attr_dev(a0, "href", "https://forms.gle/489s69zb24GaNyfK6");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$7, 16, 1, 319);
    			add_location(hr, file$7, 17, 1, 459);
    			attr_dev(i1, "class", "icon-paint-brush-fill svelte-5feb6q");
    			add_location(i1, file$7, 18, 87, 552);
    			attr_dev(a1, "class", "request-art-cta svelte-5feb6q");
    			attr_dev(a1, "href", "https://forms.gle/VKyexQDKkciK2At59");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$7, 18, 1, 466);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$7, 24, 1, 693);
    			add_location(p0, file$7, 25, 1, 724);
    			attr_dev(a0, "href", "https://forms.gle/H3UJcCATeU4CU85y5");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$7, 26, 38, 882);
    			add_location(strong, file$7, 26, 4, 848);
    			add_location(p1, file$7, 26, 1, 845);
    			add_location(br, file$7, 27, 16, 986);
    			attr_dev(a1, "href", "https://forms.gle/guyxLC6d2G9SBkzM9");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$7, 28, 1, 992);
    			add_location(p2, file$7, 27, 1, 971);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$7, 9, 0, 196);
    			add_location(h1, file$7, 34, 95, 1199);
    			attr_dev(a0, "name", "request-cta");
    			attr_dev(a0, "class", "request-help-cta");
    			add_location(a0, file$7, 34, 1, 1105);
    			attr_dev(a1, "href", "https://www.npr.org/2017/05/03/526655831/a-forgotten-history-of-how-the-u-s-government-segregated-america");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$7, 36, 58, 1315);
    			add_location(div0, file$7, 36, 2, 1259);
    			attr_dev(a2, "name", "about-link");
    			add_location(a2, file$7, 37, 28, 1560);
    			attr_dev(div1, "class", "footer-links");
    			add_location(div1, file$7, 37, 2, 1534);
    			attr_dev(div2, "class", "footer-content");
    			add_location(div2, file$7, 35, 1, 1228);
    			add_location(footer, file$7, 33, 0, 1095);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
